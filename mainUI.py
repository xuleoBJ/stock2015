...
#
# Created: Wed Dec 02 22:03:22 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tbgDailyInfor = QtGui.QWidget()
        self.tbgDailyInfor.setObjectName(_fromUtf8("tbgDailyInfor"))
        self.lineEditMarketValueSH = QtGui.QLineEdit(self.tbgDailyInfor)
        ...
        self.tabWidget.addTab(self.tbgDailyInfor, _fromUtf8(""))
        ...
        self.tbg_PatternRec = QtGui.QWidget()
        self.tbg_PatternRec.setObjectName(_fromUtf8("tbg_PatternRec"))
        self.lineEditDateRec = QtGui.QLineEdit(self.tbg_PatternRec)
        self.lineEditDateRec.setGeometry(QtCore.QRect(40, 70, 121, 21))
        self.lineEditDateRec.setObjectName(_fromUtf8("lineEditDateRec"))
        self.btnPatternRecAna = QtGui.QPushButton(self.tbg_PatternRec)
        ...
        self.label = QtGui.QLabel(self.tbg_PatternRec)
        self.label.setGeometry(QtCore.QRect(40, 160, 131, 41))
        self.label.setObjectName(_fromUtf8("label"))
        self.listWidgetMatchDate = QtGui.QListWidget(self.tbg_PatternRec)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tbgDailyInfor), _translate("MainWindow", "每日提醒", None))
        self.btnCopyData2Dir.setText(_translate("MainWindow", "数据入库", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tbg_PatternRec), _translate("MainWindow", "模式识别", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tbgMoneyManage), _translate("MainWindow", "仓位管理", None))
        self.btnCalTradePrice.setText(_translate("MainWindow", "量化交易计算", None))
        self.label_7.setText(_translate("MainWindow", "请输入交易代码：", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tbgQuanlityTrade), _translate("MainWindow", "量化交易", None))
