...
#
# Created: Wed Jan 06 19:30:53 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnAnaSpaceTime = QtGui.QPushButton(self.tbgAnaTrend)
        self.btnAnaSpaceTime.setGeometry(QtCore.QRect(30, 160, 75, 23))
        self.btnAnaSpaceTime.setObjectName(_fromUtf8("btnAnaSpaceTime"))
        ...
        self.btnMarketMoodAna_10.setGeometry(QtCore.QRect(580, 40, 101, 31))
        self.btnMarketMoodAna_10.setObjectName(_fromUtf8("btnMarketMoodAna_10"))
        self.groupBox_6 = QtGui.QGroupBox(self.tbgStockSelect)
        self.groupBox_6.setGeometry(QtCore.QRect(40, 110, 671, 111))
        self.groupBox_6.setObjectName(_fromUtf8("groupBox_6"))
        self.lineEditDateTradeTactics_2 = QtGui.QLineEdit(self.groupBox_6)
        self.lineEditDateTradeTactics_2.setGeometry(QtCore.QRect(280, 20, 71, 21))
        ...
        self.label_10.setGeometry(QtCore.QRect(210, 10, 61, 41))
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.lineEditDateTradeTactics_3 = QtGui.QLineEdit(self.groupBox_6)
        self.lineEditDateTradeTactics_3.setGeometry(QtCore.QRect(120, 20, 71, 21))
        self.lineEditDateTradeTactics_3.setObjectName(_fromUtf8("lineEditDateTradeTactics_3"))
        self.label_15 = QtGui.QLabel(self.groupBox_6)
        self.label_15.setGeometry(QtCore.QRect(50, 10, 61, 41))
        self.label_15.setObjectName(_fromUtf8("label_15"))
        self.btnMarketMoodAna_11 = QtGui.QPushButton(self.groupBox_6)
        self.btnMarketMoodAna_11.setGeometry(QtCore.QRect(510, 60, 90, 30))
        self.btnMarketMoodAna_11.setObjectName(_fromUtf8("btnMarketMoodAna_11"))
        self.label_11 = QtGui.QLabel(self.groupBox_6)
        self.label_11.setGeometry(QtCore.QRect(390, 10, 41, 41))
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.radioButton = QtGui.QRadioButton(self.groupBox_6)
        self.radioButton.setGeometry(QtCore.QRect(60, 70, 89, 16))
        self.radioButton.setObjectName(_fromUtf8("radioButton"))
        self.radioButton_2 = QtGui.QRadioButton(self.groupBox_6)
        self.radioButton_2.setGeometry(QtCore.QRect(150, 70, 89, 16))
        self.radioButton_2.setObjectName(_fromUtf8("radioButton_2"))
        self.groupBox_7 = QtGui.QGroupBox(self.tbgStockSelect)
        self.groupBox_7.setGeometry(QtCore.QRect(40, 250, 671, 111))
        self.groupBox_7.setObjectName(_fromUtf8("groupBox_7"))
        self.groupBoxKHistory = QtGui.QGroupBox(self.tbgStockSelect)
        self.groupBoxKHistory.setGeometry(QtCore.QRect(40, 400, 651, 81))
        self.groupBoxKHistory.setObjectName(_fromUtf8("groupBoxKHistory"))
        self.layoutWidget = QtGui.QWidget(self.groupBoxKHistory)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 631, 41))
        ...
        self.lineEditInputStockIDkHistory = QtGui.QLineEdit(self.layoutWidget)
        self.lineEditInputStockIDkHistory.setObjectName(_fromUtf8("lineEditInputStockIDkHistory"))
        self.horizontalLayout.addWidget(self.lineEditInputStockIDkHistory)
        self.label_13 = QtGui.QLabel(self.layoutWidget)
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.horizontalLayout.addWidget(self.label_13)
        self.lineEditDateKHistory = QtGui.QLineEdit(self.layoutWidget)
        self.lineEditDateKHistory.setObjectName(_fromUtf8("lineEditDateKHistory"))
        self.horizontalLayout.addWidget(self.lineEditDateKHistory)
        self.btnAnaKpattern = QtGui.QPushButton(self.layoutWidget)
        self.btnAnaKpattern.setObjectName(_fromUtf8("btnAnaKpattern"))
        self.horizontalLayout.addWidget(self.btnAnaKpattern)
        ...
        self.lineEditDateTradeTactics.setGeometry(QtCore.QRect(90, 90, 131, 31))
        ...
        self.lineEditPlanTradeTactics.setGeometry(QtCore.QRect(90, 140, 131, 181))
        ...
        self.label_9.setGeometry(QtCore.QRect(40, 150, 54, 12))
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.btnInertDataTradeTactics = QtGui.QPushButton(self.tbg_Data)
        self.btnInertDataTradeTactics.setGeometry(QtCore.QRect(90, 340, 101, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnAnaSpaceTime.setText(_translate("MainWindow", "时空分析", None))
        ...
        self.lineEditDateTradeTactics_2.setText(_translate("MainWindow", "12/31", None))
        self.label_10.setText(_translate("MainWindow", "结束日期：", None))
        self.lineEditDateTradeTactics_3.setText(_translate("MainWindow", "12/01", None))
        self.label_15.setText(_translate("MainWindow", "开始日期：", None))
        self.btnMarketMoodAna_11.setText(_translate("MainWindow", "分析选取", None))
        self.label_11.setText(_translate("MainWindow", "年份", None))
        self.radioButton.setText(_translate("MainWindow", "自选股", None))
        self.radioButton_2.setText(_translate("MainWindow", "海选 ", None))
        self.groupBox_7.setTitle(_translate("MainWindow", "基本面选票", None))
        self.groupBoxKHistory.setTitle(_translate("MainWindow", "历时K线分析 ", None))
        self.label_7.setText(_translate("MainWindow", "代码：", None))
        self.lineEditInputStockIDkHistory.setText(_translate("MainWindow", "999999", None))
        self.label_13.setText(_translate("MainWindow", "交易日：", None))
