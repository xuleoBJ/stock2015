...
def patternRecByPriceOpen(curStock,iTradeDay,kNum,valueOpenPrice,bias=0.5,biasOpen=0.5):
    ##根据前几日涨幅及开盘价进行历史K线模式识别：
    print ("-"*8+u"根据前{}涨幅及当日开盘价模式识别：".format(kNum))
...
def patternRecByRiseWave(curStock,iTradeDay,kNum):
    ##增加振幅，选择历史K线 
...
if __name__=="__main__":
    ...
    patternRecByPriceOpen(curStock,iTradeDay,kNum-1,valueOpenPrice)
...
#    patternRecByRiseWave(curStock,iTradeDay,kNum)
